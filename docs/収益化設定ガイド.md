...
| 商品ID | タイプ | 価格 | 説明 |
|--------|--------|------|------|
| `com.escapenine.endless.character.wizard` | 非消耗型 | ¥240 | 魔法使いキャラクター |
| `com.escapenine.endless.character.elf` | 非消耗型 | ¥240 | エルフキャラクター |
| `com.escapenine.endless.character.knight` | 非消耗型 | ¥240 | ナイトキャラクター |
| `com.escapenine.endless.removeads` | 非消耗型 | ¥480 | 広告削除 |
